...
import com.edanuryildirim.itunes.databinding.ActivityPodCastBinding
...
import kotlinx.android.synthetic.main.activity_pod_cast.*
import retrofit2.Retrofit
import retrofit2.adapter.rxjava2.RxJava2CallAdapterFactory
import retrofit2.converter.gson.GsonConverterFactory

class PodCastActivity : AppCompatActivity(),  RecyclerViewAdapter.Listener  {
    ...
    private fun loadData(){
        ...
        compositeDisposable?.add(retrofit.getPodcast()
