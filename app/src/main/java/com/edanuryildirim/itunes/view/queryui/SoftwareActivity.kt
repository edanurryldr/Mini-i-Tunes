...
import com.edanuryildirim.itunes.databinding.ActivitySoftwareBinding
...
class SoftwareActivity : AppCompatActivity(), RecyclerViewAdapter.Listener  {
    ...
    private fun loadData(){
        ...
        compositeDisposable?.add(retrofit.getSoftware()
